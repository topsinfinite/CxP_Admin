<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ManageEventHome.aspx.cs" Inherits="CustomerFeedbackSoln.BackOffice.ManageEventHome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="page-header">Home Settings Page
          </h1>
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <label for="inputbranchname">Smiley Action:</label>
             ...
             <div class="form-group">
                ...
                <asp:DropDownList ID="ddlEvt" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                     <asp:ListItem Value="" Selected="True">..Select an Event Name..</asp:ListItem>
                </asp:DropDownList>
            ...
            <div class="form-group">
                <label for="inputbranchname">Smiley Type:</label>
                <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                     <asp:ListItem Value="" Selected="True">..Select Smiley Type..</asp:ListItem>
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" InitialValue="" ForeColor="Maroon" ControlToValidate="ddlType" Display="Dynamic" Text="Required!"></asp:RequiredFieldValidator>
            </div>
            <%-- <div class="form-group" runat="server" id="dvUpload">
                <label for="inputbranchname">Upload Smiley:</label>
        ...
        <div class="col-md-6 icon-display" runat="server" ID="dvEdit" visible="true">
           ...
           <%-- <asp:Image ID="Image1" runat="server"  Height="120px" Width="120px" ImageAlign="Middle" />
             ...
             <asp:Button ID="btnUpdate" runat="server" Visible="false" Text="Update Smiley" CausesValidation="false" CssClass="btn btn-primary" OnClick="btnUpdate_Click" />
        </div>
             <div class="col-md-2">
      ...
      <div class="row page-body-control">
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading">List of Uploaded Smiley
                    ...
                    <asp:GridView ID="gvDefault" runat="server" GridLines="None"
                        ...
                        <Columns>
                           ...
                           <%-- <asp:BoundField HeaderText="Branch Code" DataField="Code" />--%>
                             <asp:BoundField HeaderText="Smiley Action" DataField="Label" />
                             <asp:TemplateField HeaderText="Smiley Type">
                                <ItemTemplate>
                                    <asp:Label ID="lbtype" runat="server" Text=' <%#GetType(Eval("SmileyType"))%>'></asp:Label>
                                   
                                </ItemTemplate>
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="Smiley">
                                   <ItemTemplate>
                                     <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("SmileyImage","~/Upload/{0}") %>' Height="60px" Width="60px" />
                                   </ItemTemplate>
                                 </asp:TemplateField>
