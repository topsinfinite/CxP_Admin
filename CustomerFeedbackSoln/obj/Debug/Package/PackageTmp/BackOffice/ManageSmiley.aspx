<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ManageSmiley.aspx.cs" Inherits="CustomerFeedbackSoln.BackOffice.ManageSmiley" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="page-header">Manage Smiley Page
          </h1>
                    ...
                    <asp:GridView ID="gvDefault" runat="server" GridLines="None"
                        ...
                        <Columns>
                           ...
                           <%-- <asp:BoundField HeaderText="Branch Code" DataField="Code" />--%>
                             <asp:BoundField HeaderText="Smiley Action" DataField="Name" />
