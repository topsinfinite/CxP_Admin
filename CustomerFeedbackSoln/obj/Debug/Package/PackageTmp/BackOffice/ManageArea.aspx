<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ManageArea.aspx.cs" Inherits="CustomerFeedbackSoln.BackOffice.ManageArea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="page-header">Manage Area Page
          </h1>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="form-group">
                <label for="inputEmail">Select Region <span>*</span></label>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" InitialValue="" ForeColor="Maroon" ControlToValidate="ddlRegion" Display="Dynamic" Text="Required!"></asp:RequiredFieldValidator>
            </div>
            <div class="form-group">
                <label for="inputbranchname">Area Name</label>
                        ...
                        <Columns>
                          ...
                          <%--  <asp:BoundField HeaderText="Branch Code" DataField="Code" />--%>
                            ...
                            <asp:TemplateField HeaderText="Region">
                                <ItemTemplate>
                                     <asp:Label ID="lbRegionID" runat="server" Text='<%#Eval("RegionalID") %>' Visible="false"></asp:Label>
                                     <asp:Label ID="lbRegion" runat="server" Text='<%#Eval("Region.Name") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Organisation">
                                <ItemTemplate>
                                     <asp:Label ID="lbOrgID" runat="server" Text='<%#Eval("Region.OrganisationID") %>' Visible="false"></asp:Label>
                                     <asp:Label ID="lbOrg" runat="server" Text='<%#Eval("Region.Organisation.OrganisationName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
