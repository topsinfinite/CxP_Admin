<%@ Page Title="" Language="C#" MasterPageFile="~/BackOffice/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ManageCategory.aspx.cs" Inherits="CustomerFeedbackSoln.BackOffice.ManageCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="page-header">Manage Feedback Category Page
          </h1>
     ...
     <div class="row">
        <div class="col-md-4">
            ...
            <div class="form-group">
                <label for="inputbranchname">Category Name</label>
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                     <asp:ListItem Value="" Selected="True">..Select Category Type..</asp:ListItem>
                </asp:DropDownList>
      ...
      <div class="row page-body-control">
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading">List of Feedback Category
                        ...
                        <Columns>
                           ...
                           <%-- <asp:BoundField HeaderText="Branch Code" DataField="Code" />--%>
                             ...
                             <asp:TemplateField HeaderText="Icon">
                                   <ItemTemplate>
                                     <asp:Image ID="Image1" runat="server" ImageUrl='<%#(Eval("CategoryIcon") != null)?Eval("CategoryIcon","~/Upload/{0}"):Eval("CategoryIcon","~/Upload/default.png") %>' Height="60px" Width="60px" />
                                   </ItemTemplate>
                                 </asp:TemplateField>
                             <asp:TemplateField HeaderText="Category Type">
                                <ItemTemplate>
                                     <asp:Label ID="lbtype" runat="server" Text=' <%#GetType(Eval("CategoryType"))%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
